...
;; Test form-type-to-jsonld-type returns strings
;; (This is automatically guaranteed by the return spec)
...
;; Test symbols-to-string-list preserves length
...
(defthm make-property-valid
  (jsonld-property-p (make-property "key" "value"))
  :hints (("Goal" :in-theory (enable make-property)))
  :rule-classes nil)

;; Test jsonld-form accessors return correct types
;; (These are automatically generated by FTY but we can verify)
